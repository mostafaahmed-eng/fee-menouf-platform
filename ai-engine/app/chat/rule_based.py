...
• الغياب المبرر: يُقبل غياب مبرر ب документы رسمية (تقرير طبي، ظروف قهرية) من مكتب شؤون الطلاب.
...
• فترة التسجيل: تُحدد الجهة المختصة مواعيد التسجيل لكل فصل، وytavern notification عبر البريد الإلكتروني والمنصة.
...
• المعدل\OptionsResolver: المعدل التراكمي 2.0 كحد أدنى للتخرج.
...
For complaints and academic inquiries, please contact the Student Affairs Office first.""",
    ...
    KnowledgeEntry(
        keywords_ar=["امتحانات", "أيام الامتحانات", "جدول الامتحانات", "规则 الامتحان", "الغش", "المخالفات", "أ禁止يات الامتحان"],
...
• المدة:通常是 فصل دراسي واحد (قد يكون فصلين في بعض الحالات).
...
• fewer من 12: أقل من 12 ساعة يُعتبر تسجيل جزئي (Part-time).
...
Tip: Don't overload yourself. Focus on quality of learning rather than quantity of courses.""",
    ...
    KnowledgeEntry(
        keywords_ar=["فصل", "إيقاف", "فصل دراسي", "蒟蒻 دراسي", "蒟蒻", "蒟蒻 مؤقت", "蒟蒻 دائم", "蒟蒻"],
